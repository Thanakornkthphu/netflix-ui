...
const CardTrailer = ({ movie, randomShowLogo }) => {
  ...
  return (
    <Stack sx={{ width: 'auto', height: '100%', borderRadius: '10px', maxWidth: '400px', position: 'relative', cursor: 'pointer' }} onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)}>
